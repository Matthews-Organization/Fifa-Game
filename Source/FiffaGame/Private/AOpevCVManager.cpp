...
// Sets default values
AAOpevCVManager::AAOpevCVManager()
{
...
void AAOpevCVManager::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AAOpevCVManager::Tick(float DeltaTime)
{
	...
	if (Camera.read(Frame))
	{
		...
		//Clean Noise? Eroding removes random noise, Dilating fills holes? (Apparently)
...
void AAOpevCVManager::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
	if (Camera.isOpened())
	{
		Camera.release();
